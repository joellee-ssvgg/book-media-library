...
import { ProviderSearchCache, LruProviderSearchCacheStore, computeCacheExpiresAt, searchProviderWithCache, } from "./cache";
...
describe("Provider Adapter", () => {
    ...
    it("returns Result.err for provider rate limits and timeouts", async () => {
        const rateLimitedFetch = async () => jsonResponse({}, 429);
    ...
    it("uses memory cache for repeated provider queries", async () => {
        ...
        const query = { mediaType: "book", text: "Dune" };
