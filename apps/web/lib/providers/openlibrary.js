...
import { asInteger, asRecord, asRecordArray, asStringArray, firstText, requestJson, } from "./utils";
function coverUrl(coverId) {
    return coverId ? `https://covers.openlibrary.org/b/id/${coverId}-M.jpg` : undefined;
}
function openLibrarySourceUrl(externalId) {
...
export function createOpenLibraryProvider(environment = {}) {
    return {
        id: "openlibrary",
        mediaTypes: ["book"],
        rateLimit: {
